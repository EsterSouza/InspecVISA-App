...
const fullClassName = 'inline-flex h-9 items-center gap-1.5 rounded-md border border-default px-3 text-xs font-semibold text-navy-2 hover:bg-surface-hover hover:text-primary-700 [@media(pointer:coarse)]:min-h-11';
const compactClassName = 'inline-flex h-8 shrink-0 items-center gap-1 rounded-md border border-default px-2 text-[11px] font-semibold text-navy-2 hover:bg-surface-hover hover:text-primary-700 [@media(pointer:coarse)]:min-h-11';
