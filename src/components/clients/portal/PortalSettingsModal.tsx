      ...
      <Card role="dialog" aria-modal="true" aria-labelledby="portal-settings-title" className="max-h-[90vh] w-full max-w-lg overflow-y-auto shadow-2xl">
        <CardContent className="p-6">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <Field
                label="Tutorial padrão do portal (PDF)"
                htmlFor="portal-settings-tutorial"
                hint="Vale para quem não tem tutorial próprio. Para dar um PDF só a um cliente, use o campo da conta em Editar acesso. URL HTTPS."
              >
                <Input
                  type="url"
              ...
              <Field
                ...
                htmlFor="portal-settings-whatsapp"
                hint="Canal institucional exibido ao cliente quando habilitado."
              >
                <Input
                  type="tel"
              ...
              <fieldset className="space-y-2 rounded-xl border border-default bg-surface-sunken p-3">
                <legend className="text-sm font-semibold text-navy">Recursos habilitados por tenant</legend>
              ...
              <Field
                ...
                htmlFor="portal-settings-grace-days"
                hint="Dias depois do vencimento antes de a conta contar como em atraso. Só conta quando há data de vencimento cadastrada, e é o que dispara a suspensão automática de agendamento."
              >
                <Input
                  type="number"
                  min={0}
