...
- **A seção de custo encolheu 67%.** Os 15 cartões com barra ocupavam 5.673px no celular, um quinto da página inteira, e repetiam o preço que já aparece dentro da ficha, na página da ficha e no comparador. Saíram. Ficaram o seletor de estado, que governa a página toda, a calculadora, que não existe em outro lugar, e o motivo das 14 fichas sem preço na SINAPI. A seção passou de 9.189 para 3.040px e a página inteira de 27.734 para 21.862px. O código da composição SINAPI continua legível, agora na página de cada ficha, e o `validar.py` confere isso lá.
