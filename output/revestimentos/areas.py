...
ONDE = {
 ...
 'P03': ('sim', 'talvez', 'nao', 'talvez',
  'O semi-grês tem absorção tipicamente acima de 4%, o limite da área crítica. Em banheiro e expurgo, confirme absorção e acabamento antiderrapante.'),
 'P04': ('sim', 'talvez', 'nao', 'talvez',
  'A cerâmica esmaltada comum passa de 4% de absorção e não alcança o critério da área crítica. Em área molhada, confirme que a peça é própria para piso e antiderrapante.'),
 ...
 'W02': ('sim', 'talvez', 'nao', 'sim',
  'O azulejo esmaltado comum passa de 4% de absorção e não alcança o critério da área crítica. Em parede de banheiro e expurgo é a solução clássica.'),
 ...
 'R03': ('sim', 'talvez', 'nao', 'nao',
  'O rodapé sobreposto forma degrau e canto vivo, e o canto não permite a limpeza completa que a norma exige. Em área molhada, a água entra pela fresta posterior.'),
