...
'P03':('Nome comercial da classe cerâmica BIIa, cuja absorção de água vai de 3% a 6%.',
'Para consultório semicrítico, examine resistência à lavagem, aos desinfetantes e à circulação. Para sala crítica, repare que a faixa da classe cruza o limite: um semi-grês de 3,5% passa dos 4%, um de 5% não passa. Só o valor medido do modelo escolhido responde, junto com o do rejunte.',
'Não use a classe como aprovação automática nem como reprovação automática: BIIa não diz se aquela peça ficou abaixo ou acima de 4%. Se o resultado medido ultrapassa 4%, a documentação não basta para a sala crítica. Uma alegação sobre o conjunto instalado precisa de comprovação própria.',
...
'P04':('Piso cerâmico com uma camada de esmalte na superfície. Esmalte é acabamento, não classe de absorção: existe peça esmaltada em todas as classes, da mais fechada à mais porosa.',
'Pode ser considerado em consultórios quando indicado para piso e resistente à rotina de limpeza. Para sala crítica não descarte pelo nome: em abril de 2026 o Centro Cerâmico do Brasil listava 27 produtos certificados como BIa esmaltado, a classe de menor absorção. O que decide é o valor na ficha técnica da peça e do rejunte.',
...
'W02':('Peça cerâmica esmaltada de parede. Azulejo é o nome da classe porosa, cuja absorção de água passa de 10%.',
'Pode ser considerada nas paredes de consultórios se suportar lavagem e desinfecção, e é a solução clássica de banheiro e expurgo. Em sala crítica não chega perto do limite de 4%: mais de 10% é a própria definição da classe. Uma peça de parede que fique em 4% ou menos não é azulejo, e está na ficha W01.',
